...
CREATE TABLE `storagetable` (
  `idelement` varchar(45) NOT NULL,
  `element` varchar(45) NOT NULL,
  `storagezone` varchar(45) NOT NULL,
...
INSERT INTO `storagetable` VALUES ('AH001','poisson','zone A','froid'),('AH002','fraise','zone A','storage type');
